...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            CollapsingToolbarLayout ctl = findViewById(R.id.appBarLayout).findViewById(R.id.collapsingToolbar);
            if (ctl != null) { // Tìm theo cấu trúc phân tầng nếu ID trực tiếp không nhận
                ctl.setTitle(name != null ? name : "Chi tiết");
            } else if (collapsingToolbar != null){
